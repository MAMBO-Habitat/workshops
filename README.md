...
We [supply data](https://github.com/MAMBO-Habitat/metadata/) for use with the code, but aim for users to be able to reproduce the results on their own data. All the functions defined in notebooks are also available in installable python packages, for use in pipelines.
